/**
THREE.OrbitControls slightly refactored
- move constants out of constructor
- reference THREE constructors in source so we don't need to load the whole library
- Move internals higher up so they're defined before we use them
